...
export const Contact: React.FC = () => {
  ...
  return (
    <section
      id="contact"
      className="relative w-full min-h-screen bg-black text-white py-24 px-6 md:px-12 flex flex-col justify-center border-t border-white/10"
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-400 text-sm md:text-base font-light mt-3 max-w-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="p-8 rounded-3xl bg-zinc-950 border border-white/5 space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:diyorbek@example.com"
          ...
          <div className="lg:col-span-7">
            <form
              ...
              className="p-8 rounded-3xl bg-zinc-950 border border-white/5 space-y-6"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-[#ff4d00] transition-colors text-sm"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-[#ff4d00] transition-colors text-sm resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-[#ff4d00] hover:bg-white hover:text-black text-white font-semibold py-4 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 cursor-pointer"
              >
