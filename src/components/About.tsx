    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-6">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-zinc-900/40 border border-white/5 hover:border-[#ff4d00]/40 transition-all duration-300 group"
              >
                <div className="text-4xl md:text-5xl font-black font-mono text-white group-hover:text-[#ff4d00] transition-colors">
                  {stat.value}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 pt-12 border-t border-white/5">
          <div className="p-6 rounded-xl bg-zinc-950 border border-white/5 space-y-3">
            <Code2 className="w-8 h-8 text-[#ff4d00]" />
            <h3 className="text-lg font-semibold text-white">Toza Kod</h3>
          ...
          <div className="p-6 rounded-xl bg-zinc-950 border border-white/5 space-y-3">
            ...
            <h3 className="text-lg font-semibold text-white">Yuqori Tezlik</h3>
            <p className="text-xs text-gray-400 leading-relaxed">
          ...
          <div className="p-6 rounded-xl bg-zinc-950 border border-white/5 space-y-3">
            ...
            <h3 className="text-lg font-semibold text-white">Interaktiv UI</h3>
            <p className="text-xs text-gray-400 leading-relaxed">
